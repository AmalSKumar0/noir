...
| `login` | `noir login` | Authenticates user credentials with Noir backend via email/password. |
| `login github` | `noir login github` | Authenticates developer session via GitHub OAuth in browser. |
| `login google` | `noir login google` | Authenticates developer session via Google OAuth in browser. |
